...
public class XLMariaDBConnection{
...
//	
	...
	// gssg - xl m2m 기능 추가
	private byte dbType = XLCons.MARIADB;

	
	public  XLMariaDBConnection(String _dbIp, String _dbSid, String _userId, String _passwd, int _port, byte _dbType){
		this.dbIp = _dbIp;
		this.dbSid = _dbSid;
		this.userId = _userId;
		this.passwd = _passwd;
