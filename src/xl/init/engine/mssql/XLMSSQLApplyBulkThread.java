...
import xl.init.engine.mssql.XLMSSQLLoaderThread;
...
public class XLMSSQLApplyBulkThread extends Thread {
	...
	private XLMSSQLLoaderThread loaderThread = null;
	...
	public XLMSSQLApplyBulkThread(XLJobRunPol jobRunPol) {
		super();
	...
	public void run(){
		...
		loaderThread = new XLMSSQLLoaderThread(this.jobRunPol);
		loaderThread.start();
