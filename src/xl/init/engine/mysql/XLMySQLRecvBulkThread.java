...
public class XLMySQLRecvBulkThread extends Thread {
	...
	public XLMySQLRecvBulkThread(XLJobRunPol jobRunPol) {
		super();
...
//			}
//				
//				try { if ( this.mySQLConnObj != null && this.jobRunPol.isLoadQuery() ) this.mySQLConnObj.closeConnection(); } catch (Exception e) {} finally { this.mySQLConnObj = null; }							
