...
public class XLPPASRecvBulkThread extends Thread {
	...
	public XLPPASRecvBulkThread(XLJobRunPol jobRunPol) {
		super();
...
//			this.dataQ.addDataQ(vtDataSend);
			...
			try { if ( this.ppasConnObj != null && this.jobRunPol.isLoadQuery() ) this.ppasConnObj.closeConnection(); } catch (Exception e) {} finally { this.ppasConnObj = null; }
